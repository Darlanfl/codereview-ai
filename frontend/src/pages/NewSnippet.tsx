        ...
        <div className="min-h-screen bg-slate-900 px-4 py-8">
            <div className="max-w-2xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-slate-800 rounded-xl p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-slate-300 text-sm mb-1">Linguagem</label>
                        <select
                            value={language}
                    ...
                    <div>
                        <label className="block text-slate-300 text-sm mb-1">Código</label>
                        <textarea
                            value={code}
                            onChange={(e) => setCode(e.target.value)}
                            required
                            rows={10}
                            className="w-full bg-slate-950 text-slate-200 font-mono text-sm rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-emerald-400"
